/*
 ...
 Створіть функцію `curriedAdd`, яка демонструє принцип карування в JavaScript. Функція повинна приймати три числові
  аргументи, кожен з яких передається послідовно, і повертати суму цих трьох чисел.
